  ...
  return (
    <div className="App">
      ...
      <header className={`${scrollHeader ? 'header scroll-header' : 'header'}`} id="header">
        <nav className="nav container">
          <a className="nav__logo" href="#home">
            ReLOCATE <i className="bx bxs-home-alt-2"></i>
          </a>
      ...
      <main className="main">
        ...
        {/*==================== POPULAR ====================*/}
        <PopularResidence></PopularResidence>
        ...
        <section className="subscribe section">
          <div className="subscribe__container container">
            <h1 className="subscribe__title">Get Started with ReLOCATE</h1>
